...
class AboutDialog(QDialog):
    def __init__(self, *args, **kwargs):
        ...
        layout.addWidget(QLabel("GPL Browser_tabbed Inc."))
...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        about_action = QAction(QIcon(os.path.join('images', 'question.png')), "About Browser_tabbed", self)
        about_action.setStatusTip("Find out more about Browser_tabbed")  # Hungry!
        about_action.triggered.connect(self.about)
        help_menu.addAction(about_action)

        navigate_mozarella_action = QAction(QIcon(os.path.join('images', 'lifebuoy.png')),
                                            "Browser_tabbed Homepage", self)
        navigate_mozarella_action.setStatusTip("Go to Browser_tabbed Homepage")
        ...
        self.setWindowTitle("Browser_tabbed")
    ...
    def update_title(self, browser):
        ...
        self.setWindowTitle("%s - Browser_tabbed" % title)
...
app.setApplicationName("Browser_tabbed")
